...
// 中立(平均0)にして全員相思相愛のインフレを防ぐ。好意も嫌悪もランダムウォークで育つ。
export const AFFINITY_MIN_DELTA = -3;
export const AFFINITY_MAX_DELTA = 3;
export const REPRO_AFFINITY = 3;
// 結婚に必要な相互親愛度(高め=深い絆/恋愛感情がある相手とだけ結婚。なんとなく結婚を防ぐ)
export const MARRIAGE_AFFINITY = 6;
export const CHILD_NAMES = [
  'ハル', 'ナギ', 'ソラ', 'ツキ', 'リン', 'カイ', 'ユウ', 'ミオ', 'アオ', 'ノゾミ',
  'イト', 'レン', 'ヒナ', 'マコト', 'タケル', 'ミドリ', 'カエデ', 'ハヤテ', 'ツムギ', 'アサヒ',
  'シオン', 'ナルミ', 'トワ', 'スバル', 'コハク', 'セナ', 'アカリ', 'リク', 'ハナ', 'ジン',
  'サキ', 'ノア', 'ルイ', 'カナ', 'ソウ', 'ミク', 'タイガ', 'ユキ', 'レイ', 'ハヤト',
];
// 子供期間: この間は労働・収入なし、食費は親が払う。過ぎると大人になり自立。
export const CHILDHOOD_MS = 30 * 60 * 1000; // 約30分(sim稼働時間)で成人

// --- 共同建造(村の目標 & 金の出口) ---
// 村人が金を出し合って一つの大事業を完成させる。拠出した金は戻らない(=出口)。
export const PROJECT_GOAL = '村のみんなの大きな船';
export const PROJECT_TARGET = 3000; // 完成に必要な総額(チューニング可)
